package com.example.requestparam.controllers;
...
public class RequestParamController {
   ...
   @ResponseBody
   public String handler(@RequestParam("fav") String favoriteColor,
		   				 @RequestParam("leastFav") String leastFavoriteColor,
		   				 @RequestParam("honMen") String honorableMention,
		   				 @RequestParam("name") String name){
   		return "URL parameters - <br>"
   				+ "Favorite color = " + favoriteColor + " <br>"
   				+ "Least favorite color = " + leastFavoriteColor + " <br>"
   				+ "Honorable mention = " + honorableMention + " <br>"
   				+ "Terrible take by = " + name;
   	}
   
//http://localhost:8080/request9?fav=blue&leastFav=green&honMen=red&name=bryce
}