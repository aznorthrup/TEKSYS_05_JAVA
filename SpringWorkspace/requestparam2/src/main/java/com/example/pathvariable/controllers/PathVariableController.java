...
public class PathVariableController {
   ...
   @RequestMapping("/request7/{fav}/{leastFav}/{honMen}/{name}")
   @ResponseBody
   public String handler(@PathVariable("fav") String favoriteColor,
		   				 @PathVariable("leastFav") String leastFavoriteColor,
		   				 @PathVariable("honMen") String honorableMention,
...
//http://localhost:8080/request7/Blue/Green/Red/Bryce
}